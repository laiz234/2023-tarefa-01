    ...
    <>
      <div className="todo-list">
        <div className="todo-item">
          ...
          <a
            href="javascript:void(0);" className="float-right remove-todo-item"><i className="icon-close"></i></a>
        </div>
        ...
        <div className="todo-item">
          ...
          <a
            ...
            className="float-right remove-todo-item"><i className="icon-close"></i></a>
        </div>
